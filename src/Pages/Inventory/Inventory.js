        ...
        <div className='container'>
            ...
            <nav class="bg-white">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto"> <Link to="/services" class="text-uppercase">Back to shopping</Link> </div>
                </div>
            </nav>
            <header>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-10 offset-lg-0 offset-md-2 offset-sm-1">
                        ...
                        <div id="details" class="bg-white rounded pb-5">
                            <form>
                                <div class="form-group"> <label class="text-muted">Name</label> <input type="text" value={user?.displayName} class="form-control" /> </div>
                                <div class="form-group"> <label class="text-muted">Email</label>
                                    <div class="d-flex jusify-content-start align-items-center rounded p-2"> <input type="email" value={user?.email} /> <span class="fas fa-check text-success pr-sm-2 pr-0"></span> </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-10 offset-lg-0 offset-md-2 offset-sm-1 pt-lg-0 pt-3">
                        ...
                        <div class="row pt-lg-3 pt-2 buttons mb-sm-0 mb-2">
                            <div class="col-md-6">
                                <div class="btn text-uppercase"><Link to="/services" class="text-uppercase">Back to shopping</Link> </div>
                            </div>
                            <div class="col-md-6 pt-md-0 pt-3">
                                <div class="btn text-white ml-auto"> <span class="fas fa-lock"></span> <Link to="/services" class="text-uppercase">Continue to Shopping </Link> </div>
                            </div>
                        </div>
